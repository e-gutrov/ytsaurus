...
function(target_proto_plugin Tgt Name PluginTarget)
  set_property(TARGET ${Tgt} APPEND PROPERTY
    PROTOC_OPTS --${Name}_out=${YT_BINARY_DIR}/$<TARGET_PROPERTY:${Tgt},PROTO_NAMESPACE> --plugin=protoc-gen-${Name}=$<TARGET_FILE:${PluginTarget}>
  )
  set_property(TARGET ${Tgt} APPEND PROPERTY
...
function(target_proto_messages Tgt Scope)
  ...
  foreach(proto ${ARGN})
    if(proto MATCHES ${YT_BINARY_DIR})
      file(RELATIVE_PATH protoRel ${YT_BINARY_DIR} ${proto})
    elseif (proto MATCHES ${YT_SOURCE_DIR})
      file(RELATIVE_PATH protoRel ${YT_SOURCE_DIR} ${proto})
    else()
      set(protoRel ${proto})
    endif()
    get_filename_component(OutputBase ${protoRel} NAME_WLE)
    get_filename_component(OutputDir ${YT_BINARY_DIR}/${protoRel} DIRECTORY)
    ...
    add_custom_command(
        ...
        WORKING_DIRECTORY ${YT_SOURCE_DIR}
