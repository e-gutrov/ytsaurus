...
function(target_rodata_sources TgtName Scope)
  foreach(rodata ${ARGN})
    ...
    add_custom_command(
        ...
        COMMAND Python3::Interpreter ${YT_SOURCE_DIR}/build/scripts/rodata2cpp.py ${CppVar} ${rodata} ${CMAKE_CURRENT_BINARY_DIR}/${CppVar}.cpp
        DEPENDS ${YT_SOURCE_DIR}/build/scripts/rodata2cpp.py ${rodata}
    )
