function(target_bison_parser Tgt Scope)
  foreach(arg ${ARGN})
    ...
    if (argPath MATCHES "${YT_SOURCE_DIR}/.*")
    ...
    add_custom_command(
      ...
      COMMAND ${CMAKE_COMMAND} -E env M4=${YT_BINARY_DIR}/bin/m4/bin/m4 ${YT_BINARY_DIR}/bin/bison/bin/bison ${BISON_FLAGS} -v --defines=${OutputDir}/${OutputBase}.h -o ${OutputDir}/${OutputBase}.cpp ${arg}
      DEPENDS ${arg}
    )
